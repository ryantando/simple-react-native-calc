...
import {onlyAllowNumber, generateFibonacci} from '../utils/function';
    ...
    <ResultContainer bgLeftStyle={styles.bgLeft} bgRightStyle={styles.bgRight}>
      <View style={generalStyles.resultContainer}>
        ...
        <View style={{marginHorizontal: width * 0.2}}>
          ...
          <ViewRow>
            <Text style={generalStyles.operatorResult}>Fibonacci</Text>
          </ViewRow>
...
export default FirstNFibonacci;
